...
public class Triangle extends GeometricObject {
    ...
    public double getArea() {
        return (1d / 4d) * Math.sqrt(
          (this.sideLengths[0] + (this.sideLengths[1] - this.sideLengths[2]) * (this.sideLengths[0] - this.sideLengths[1] + this.sideLengths[2]) * (-this.sideLengths[0] + this.sideLengths[1] + this.sideLengths[2]) * (this.sideLengths[0] + this.sideLengths[1] + this.sideLengths[2])));
    }
    ...
    public String getDescription() {
        return "A " + this.colour + " triangle with sides of length " + Arrays
          .toString(this.sideLengths)
          .replaceAll("\\[|\\]", " ") + " and it is " + (this.filled ? "filled." : "not filled.");
    }
